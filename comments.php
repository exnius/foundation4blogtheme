 ...
 * handled by a callback to foundation4blogtheme_comment() which is
...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'foundation4blogtheme' ),
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use foundation4blogtheme_comment() to format the comments.
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'foundation4blogtheme' ); ?></p>
	<?php endif; ?>
